...
def test_semantic_cache_v2_integration():
    ...
    paraphrased_query = "Điều kiện về năng lực tài chính khi tham gia đấu thầu yêu cầu những gì"
    ...
    assert new_semantic_count > initial_semantic_count, "Semantic embedding should be stored"
    ...
    assert cache_type2 == "semantic_v2", f"Cache type should be 'semantic_v2', got '{cache_type2}'"
